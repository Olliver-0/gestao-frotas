...
// Mesmo que Services e Views estejam vazias, isso já prepara o código.
// Enquanto as pastas estiverem vazias essas linhas darão erro, é só descomentar depois que tiverem conteúdo.
...
namespace GestaoFrotas.ConsoleApp
{
    class Program
    {
        ...
        // private static VeiculoView _veiculoView = new VeiculoView();
        ...
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                {
                    case "1":
                        // _veiculoView.ExibirMenuVeiculos(); // Pessoa 1 vai descomentar
                        Console.WriteLine("Módulo de Veículos em construção...");
                        Console.ReadKey();
                        break;
                    case "2":
