...
namespace GestaoFrotas.ConsoleApp.Views
{
  ...
  {private readonly OsService _osService;
    ...
    public OsView(OsService osService, VeiculoService veiculoService, MotoristaService motoristaService)
  {
    ...
    public void ExibirMenuOS()
    {
      while (true)
      {
        Console.Clear();
        Console.WriteLine("=========================================");
        Console.WriteLine(" GERENCIAR ORDEM DE SERVIÇO ");
        Console.WriteLine("=========================================");
        Console.WriteLine();
        Console.WriteLine("1 - Criar Ordem de Serviço");
        Console.WriteLine("2 - Consultar Ordem de Serviço");
        Console.WriteLine("3 - Listar OS Abertas");
        Console.WriteLine("4 - Listar OS Finalizadas");
        Console.WriteLine();
    ...
    private void ConsultarOs()
    {
      Console.Clear();
      Console.WriteLine("=========================================");
      Console.WriteLine(" CONSULTAR ORDEM DE SERVIÇO ");
      Console.WriteLine("=========================================");
    ...
    private void ExibirDadosDaOs(OrdemDeServico os)
    {
      string placa = _veiculoService.ListarTodos().FirstOrDefault(v => v.idFrota == os.veiculoId)?.placa ?? "N/A";
